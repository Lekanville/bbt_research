...
def the_variables(INPUT, OUTPUT):
    ...
    temperatures_trimmed_out = tools.trimming_for_outliers_MM(temperatures) #trim out outliers at the nadirs and peaks
    ...
    "User", "Cycle", "MinMax_distance", "MinMax_nadir_day", "MinMax_peak_day", "MinMax_nadir_temp_actual",  
    "MinMax_peak_temp_actual", "MinMax_nadir_to_peak", "MinMax_low_to_high_temp", "nadir_valid", "peak_valid",
