...
def user_level_learning(INPUT, SPLITS, OUTPUT):
    ...
    #RFC SHAP Explainer
    shap_explainer("User Level", "RFC", explainers, x_tests, OUTPUT)
    #RFC variable importance
    plot_importance("User Level", "RFC Model Importance", rfc_importance, OUTPUT)
    ...
    #SVM SHAP Explainer
    shap_explainer("User Level", "SVM", explainers, x_tests, OUTPUT)
    #SVM variable importance
    plot_importance("User Level", "SVM Model Importance", svm_importance, OUTPUT)
    ...
    plot_importance("User Level", "LogReg Model Importance", logreg_importance, OUTPUT)
