...
def user_level_learning(INPUT, SPLITS, OUTPUT):
    ...
    plot_importance("User Level", "RFC Model Importance", rfc_model, OUTPUT)
    ...
    plot_importance("User Level", "SVM Model Importance", svm_model, OUTPUT)
    ...
    plot_importance("User Level", "LogReg Model Importance", logreg_model, OUTPUT)
