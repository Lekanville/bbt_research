...
def user_level_learning(INPUT, SPLITS, OUTPUT):
    ...
    for alg in algorithms:
        ...
        shap_values, mean_tpr, mean_auc, std_auc, tprs_upper, tprs_lower = classifier_roc_cross_val("User Level", alg, df_for_learning, OUTPUT)
        ...
        shap_explainer("User Level", alg, shap_values, OUTPUT)
    ...
    plt.title('Mean ROC for User Level Learning')
    plt.legend(loc="lower right")
    filename = "user_level_ML.png"
    plt.savefig(os.path.join(OUTPUT, filename))

    # #RFC classifier
    # logger.info("Performing Random Forest Classification")
    # #rfc_importance, explainers, x_tests = classifier_roc_cross_val("User Level", "RFC", df_for_learning, OUTPUT)
    # #rfc_importance, shap_values = classifier_roc_cross_val("User Level", "RFC", df_for_learning, OUTPUT)
    # shap_values, mean_tpr, mean_auc, std_auc = classifier_roc_cross_val("User Level", "RFC", df_for_learning, OUTPUT)
    # all_mean_tpr.append(mean_tpr)
    # all_mean_auc.append(mean_auc)
    # all_std_auc.append(std_auc)
    ...
    # shap_explainer("User Level", "RFC", shap_values, OUTPUT)
    ...
    # #svm_importance, explainers, x_tests = classifier_roc_cross_val("User Level", "SVM", df_for_learning, OUTPUT)
    # #svm_importance, shap_values = classifier_roc_cross_val("User Level", "SVM", df_for_learning, OUTPUT)
    # shap_values, mean_tpr, mean_auc, std_auc = classifier_roc_cross_val("User Level", "SVM", df_for_learning, OUTPUT)
    # all_mean_tpr.append(mean_tpr)
    # all_mean_auc.append(mean_auc)
    # all_std_auc.append(std_auc)
    ...
    # shap_explainer("User Level", "SVM", shap_values, OUTPUT)
    ...
    # #logreg_importance, explainers, x_tests = classifier_roc_cross_val("User Level", "LogReg", df_for_learning, OUTPUT)
    # #logreg_importance, shap_values = classifier_roc_cross_val("User Level", "LogReg", df_for_learning, OUTPUT)
    # shap_values, mean_tpr, mean_auc, std_auc = classifier_roc_cross_val("User Level", "LogReg", df_for_learning, OUTPUT)
    # all_mean_tpr.append(mean_tpr)
    # all_mean_auc.append(mean_auc)
    # all_std_auc.append(std_auc)

    # #LogReg SHAP Explainer
    # #shap_explainer("User Level", "LogReg", explainers, x_tests, OUTPUT)
    # shap_explainer("User Level", "LogReg", shap_values, OUTPUT)
