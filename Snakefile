...
rule sel_cr_1:
    ...
    params:
        ...
        cr_1_2 = 5,
    shell:"""
        python -m sel_crt_1 -d '{input.input_file}' -x {params.cr_1_1} -y {params.cr_1_2} > {output.output_file}
        """
rule sel_cr_2:
    input:
    ...
    params:
        ...
        cr_2_3 = 3
    shell:"""
        python -m sel_crt_2 -d '{input.input_file}' -r {params.cr_2_1} -n {params.cr_2_2} -c {params.cr_2_3} > {output.output_file}
        """
rule plot_temps:
    input:
